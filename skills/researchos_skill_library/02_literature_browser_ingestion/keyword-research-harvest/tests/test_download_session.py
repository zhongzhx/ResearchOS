...
class TestDownloadSession(unittest.TestCase):
    ...
    def test_extract_pdf_url_from_html_meta(self):
        """PMC-style citation_pdf_url meta tags are followed."""
        html = '<meta name="citation_pdf_url" content="pdf/article.pdf">'
        self.assertEqual(
            self.session.extract_pdf_url_from_html(html, "https://pmc.ncbi.nlm.nih.gov/articles/PMC1/"),
